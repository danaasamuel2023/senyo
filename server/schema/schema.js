...
const BlockedDeviceSchema = new mongoose.Schema({
  ...
  blockedBy: { type: mongoose.Schema.Types.ObjectId, ref: "Userdataunlimited" }
});

// Friend Registration Schema - for tracking registered friends
const RegisteredFriendSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: "Userdataunlimited" },
  name: { type: String },
  email: { type: String },
...
const UserSchema = new mongoose.Schema({
  ...
  registeredByUserId: { type: mongoose.Schema.Types.ObjectId, ref: "Userdataunlimited" }, // User who registered this user
...
const DataPurchaseSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: "Userdataunlimited", required: true }, 
  ...
  updatedBy: { type: mongoose.Schema.Types.ObjectId, ref: "Userdataunlimited" },
  updatedAt: { type: Date },
  createdAt: { type: Date, default: Date.now }
...
const ReferralBonusSchema = new mongoose.Schema({
  userId: { type: mongoose.Schema.Types.ObjectId, ref: "Userdataunlimited", required: true }, 
  referredUserId: { type: mongoose.Schema.Types.ObjectId, ref: "Userdataunlimited", required: true }, 
...
const DataPurchase = mongoose.model("DataPurchasedataunlimited", DataPurchaseSchema);
const Transaction = mongoose.model("Transactiondataunlimited", TransactionSchema);
const ReferralBonus = mongoose.model("ReferralBonusdataunlimited", ReferralBonusSchema);
const ApiKey = mongoose.model('ApiKeydatahusle', apiKeySchema);
const DataInventory = mongoose.model("DataInventorydataunlimited", DataInventorySchema);
const OrderReport = mongoose.model("OrderReportunlimited", OrderReportSchema);
